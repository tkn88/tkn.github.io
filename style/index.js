$(function(){
    ...
    var floor1Init = false,
        ...
        tileA = $('https://www.etctrans.com/style/.tileA .tile'),

        tileB = $('https://www.etctrans.com/style/.tileB .tile'),
	...
	$('.float_list li').hover(function(){
		...
		$(this).find('a').stop().animate({"width":"170px"},450)
			...
			$(this).find('a').css({"background-color":"#000","opacity":"0.7","width":"120px"})

			$(this).find('a').stop().animate({"width":"120px"},450)
